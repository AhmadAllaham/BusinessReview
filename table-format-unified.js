(() => {
  ...
  style.textContent = `
    :root{
      --br-table-bg:#ffffff;
      --br-table-bg-alt:#f8fbfc;
      --br-table-head:#eaf2f4;
      --br-table-head-2:#dfeaec;
      --br-table-total:#e8f5f3;
      --br-table-group:#f0f6f7;
      --br-table-line:#d7e2e6;
      --br-table-line-soft:#e8eef1;
      --br-table-text:#26323b;
      --br-table-muted:#6f7f89;
      --br-table-accent:#218f82;
      --br-table-hover:#eef8f6;
      --br-table-shadow:0 9px 28px rgba(18,45,57,.08);
    ...
    .br-table-shell::-webkit-scrollbar{height:9px;width:9px}
    .br-table-shell::-webkit-scrollbar-track{background:transparent}
    .br-table-shell::-webkit-scrollbar-thumb{
    ...
    table.br-unified-table thead{
      background:var(--br-table-head) !important;
    }

    table.br-unified-table thead th{
    ...
    table.br-unified-table thead tr:nth-child(n+2) th{
      top:48px !important;
      z-index:6 !important;
    ...
    table.br-unified-table thead th:first-child{
      left:0;
      z-index:9 !important;
      text-align:left !important;
    }

    table.br-unified-table thead tr:nth-child(n+2) th:first-child{z-index:8 !important}

    table.br-unified-table tbody td,
    table.br-unified-table tfoot td{
    ...
    table.br-unified-table tbody tr:nth-child(even):not(.total-row):not(.grand-total):not(.subtotal-row):not([class*="total-row"]) td{
      background:var(--br-table-bg-alt) !important;
    }

    table.br-unified-table tbody tr:hover td{
      background:var(--br-table-hover) !important;
    }

    table.br-unified-table th:first-child,
    table.br-unified-table td:first-child{
      text-align:left !important;
      font-weight:650 !important;
    }

    table.br-unified-table th:not(:first-child),
    table.br-unified-table td:not(:first-child){
      text-align:right !important;
      font-variant-numeric:tabular-nums !important;
    }

    table.br-unified-table th:last-child,
    table.br-unified-table td:last-child{
      border-right:0 !important;
    }

    table.br-unified-table tbody tr:last-child td,
    table.br-unified-table tfoot tr:last-child td{
      border-bottom:0 !important;
    }

    table.br-unified-table tr.total-row td,
    table.br-unified-table tr.grand-total td,
    table.br-unified-table tr.subtotal-row td,
    table.br-unified-table tr.pnl-total-row td,
    table.br-unified-table tr.sm-total-row td,
    table.br-unified-table tr.stock-total-row td,
    table.br-unified-table tr[class*="total-row"] td,
    table.br-unified-table tfoot td{
    ...
    table.br-unified-table tr.group-row td,
    table.br-unified-table tr.category-row td,
    table.br-unified-table tr.parent-row td,
    table.br-unified-table tr.section-row td,
    table.br-unified-table tr[class*="group-row"] td{
    ...
    table.br-unified-table td.highlight,
    table.br-unified-table th.highlight,
    table.br-unified-table td[class*="highlight"]{
      background:color-mix(in srgb,var(--br-table-accent) 12%,var(--br-table-bg)) !important;
    }

    table.br-unified-table .positive,
    table.br-unified-table td.positive,
    table.br-unified-table .favorable{
      color:#2bcf7c !important;
      font-weight:750 !important;
    }

    table.br-unified-table .negative,
    table.br-unified-table td.negative,
    table.br-unified-table .unfavorable{
      color:#ff6b76 !important;
      font-weight:750 !important;
    }

    table.br-unified-table .drill-link,
    table.br-unified-table a{
      color:var(--br-table-accent) !important;
      font-weight:750 !important;
      text-underline-offset:3px;
    }

    table.br-unified-table th::after{
      color:var(--br-table-muted) !important;
      opacity:.75 !important;
    }

    table.br-unified-table th.sort-asc::after,
    table.br-unified-table th.sort-desc::after{
      color:var(--br-table-accent) !important;
      opacity:1 !important;
    }

    .br-table-toolbar-unified{
    ...
    .br-table-toolbar-unified + .br-table-shell,
    .br-table-toolbar-unified + * .br-table-shell{
    ...
    @media(max-width:900px){
      table.br-unified-table{font-size:12px !important}
      table.br-unified-table thead th{padding:10px 11px !important;font-size:11px !important}
      table.br-unified-table tbody td,
      table.br-unified-table tfoot td{padding:9px 11px !important;font-size:12px !important}
    }
  `;
  ...
  window.addEventListener('brthemechange',() => scan());
  window.BRRefreshUnifiedTables = () => scan();
})();
